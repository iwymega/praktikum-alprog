...
//deklarasi variabel global
	int menu, pil;
	double d1, d2, alas, tinggi, sejajaralas, semesta, luas,  keliling, kalisemesta, sisi, jari_jari, phi=3.14, sisiluar, alas_siku_siku, alas_disamping_siku_siku, sisi_miring, sisi1, sisi2, sisi3;
	char charpilihan;
...
void hitungsegitiga(){
	...
	printf("\n\n\tLuas segitiga sembarang dari sisi 1 2 dan 3 adalah : %f \n", luas );
	printf("\tKeliling segitiga sembarang dari sisi 1 2 dan 3 adalah : %f \n", keliling);
}
void hitungbelahketupat(){
	luas = (d1 * d2)/2;
	sisiluar = sqrt(((0.5*d1)*(0.5*d1)) + ((0.5*d2)*(0.5*d2)));
	keliling = 4 * sisiluar;
	printf("\n\tLuas belah ketupat yang diketahui diagonalnya adalah : %f", luas);
	printf("\n\tKeliling belah ketupat yang diketahui diagonalnya adalah : %f", keliling);
}
void hitungjajargenjang(){
	...
	printf("\n\tSisi miring dari jajargenjang adalah : %f", sisiluar);
	printf("\n\tLuas jajargenjang dari inputan di atas adalah : %f", luas);
	printf("\n\tKeliling jajargenjang dari inputan di atas adalah : %f", keliling);
}
void hitungtrapesium(){
	...
	printf("\n\tLuas dari trapesium dengan inputan alas : %f, sisisejajar : %f, dan tinggi : %f adalah : %f", alas,sejajaralas,tinggi,luas);
	printf("\n\tKeliling dari trapesium dengan inputan alas : %f, sisisejajar : %f, dan tinggi : %f adalah : %f", alas,sejajaralas,tinggi,keliling);
}
void hitunglingkaran(){
	luas = phi * jari_jari * jari_jari;
	keliling = 2 * phi * jari_jari;	
	printf("\n\tLuas lingkaran dengan jari-jari %f adalah : %f\n", jari_jari, luas);
	printf("\n\tKeliling lingkaran dengan jari-jari %f adalah : %f\n", jari_jari, keliling); 
}
///////////      validasi        ///////////
