...
int inputmenu(){
 	...
 	if(scanf("%d%c", &pilihan, &charpilihan) != 2 || charpilihan != '\n'){
...
float hitungvollimas (){
	...
	printf("Sisi Alas\t: ");
	sisi_alas=validcek();
	} while (sisi_alas==0 || sisi_alas<0);
	do {
	printf("Tinggi\t\t: ");
	tinggi=validcek();
	} while (tinggi==0 || tinggi<0);
...
float hitungvolprisma (){
	...
	fflush(stdin);
	sisi_alas1=validcek();
	} while (sisi_alas1==0 || sisi_alas1<0);
	do {
	printf("Sisi Alas Kedua\t\t: ");
	fflush(stdin);
	sisi_alas2=validcek();
	} while ((sisi_alas2==sisi_alas1) || (sisi_alas2== 0)|| (sisi_alas2<0));
	do {
	printf("Sisi Alas Ketiga\t: ");
	fflush(stdin);
	sisi_alas3=validcek();
	} while ((sisi_alas3==sisi_alas2)||(sisi_alas3==sisi_alas1)|| (sisi_alas3==0)|| (sisi_alas3<0));
	do {
	printf("Tinggi Prisma\t\t: ");
	tinggi_prisma=validcek();
	} while (tinggi_prisma==0|| tinggi_prisma<0);
...
float hitungvolkerucut (){
	...
	} while (tinggi_kerucut==0|| tinggi_kerucut<0);
...
int pilihanmenu1 (){
	...
	if(scanf("%d%c", &menu, &charmenu) != 2 || charmenu != '\n'){
		
		fflush(stdin);
		system ("cls");
		printf("%d",pilihanmenu1());
  	}
	system("cls");
	switch(menu){
		case 1: 
